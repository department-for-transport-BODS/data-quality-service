...
from sqlalchemy import ARRAY, BigInteger, Boolean, CheckConstraint, Date, DateTime, ForeignKeyConstraint, Identity, Integer, PrimaryKeyConstraint, String, Text, Time, UniqueConstraint
...
class OrganisationDataset(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(['contact_id'], ['users_user.id'], deferrable=True, initially='DEFERRED', name='organisation_dataset_contact_id_b440c22b_fk_users_user_id'),
        ForeignKeyConstraint(['live_revision_id'], ['organisation_datasetrevision.id'], deferrable=True, initially='DEFERRED', name='organisation_dataset_live_revision_id_e30c3fa4_fk_organisat'),
        ForeignKeyConstraint(['organisation_id'], ['organisation_organisation.id'], deferrable=True, initially='DEFERRED', name='organisation_dataset_organisation_id_384c7a11_fk_organisat'),
...
class OrganisationDatasetrevision(Base):
    ...
    __table_args__ = (
        ...
        ForeignKeyConstraint(['dataset_id'], ['organisation_dataset.id'], deferrable=True, initially='DEFERRED', name='organisation_dataset_dataset_id_f0cd70df_fk_organisat'),
        ForeignKeyConstraint(['last_modified_user_id'], ['users_user.id'], deferrable=True, initially='DEFERRED', name='organisation_dataset_last_modified_user_i_cfda7737_fk_users_use'),
        ForeignKeyConstraint(['published_by_id'], ['users_user.id'], deferrable=True, initially='DEFERRED', name='organisation_dataset_published_by_id_4e5c02d1_fk_users_use'),
...
class OtcInactiveservice(Base):
    ...
    __table_args__ = (
        ...
        UniqueConstraint('registration_number', name='otc_inactiveservice_registration_number_key')
    )
...
class DqsReport(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(['revision_id'], ['organisation_datasetrevision.id'], deferrable=True, initially='DEFERRED', name='dqs_report_revision_id_6eda8a8d_fk_organisat'),
...
class NaptanAdminarea(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(['ui_lta_id'], ['ui_lta.id'], deferrable=True, initially='DEFERRED', name='naptan_adminarea_ui_lta_id_c37d8a17_fk_ui_lta_id'),
...
class OrganisationOrganisation(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(['key_contact_id'], ['users_user.id'], deferrable=True, initially='DEFERRED', name='organisation_organis_key_contact_id_df58d4ce_fk_users_use'),
...
class OrganisationTxcfileattributes(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(['revision_id'], ['organisation_datasetrevision.id'], deferrable=True, initially='DEFERRED', name='organisation_txcfile_revision_id_ddb2f841_fk_organisat'),
...
class OtcService(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(['licence_id'], ['otc_licence.id'], deferrable=True, initially='DEFERRED', name='otc_service_licence_id_8b93ea5f_fk_otc_licence_id'),
        ForeignKeyConstraint(['operator_id'], ['otc_operator.id'], deferrable=True, initially='DEFERRED', name='otc_service_operator_id_26fe49fe_fk_otc_operator_id'),
...
class TransmodelServicepattern(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(['revision_id'], ['organisation_datasetrevision.id'], deferrable=True, initially='DEFERRED', name='transmodel_servicepa_revision_id_6917ba40_fk_organisat'),
...
class DqsTaskresults(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(['checks_id'], ['dqs_checks.id'], deferrable=True, initially='DEFERRED', name='dqs_taskresults_checks_id_a474fbd2_fk_dqs_checks_id'),
        ForeignKeyConstraint(['dataquality_report_id'], ['dqs_report.id'], deferrable=True, initially='DEFERRED', name='dqs_taskresults_dataquality_report_id_b3cfb422_fk_dqs_report_id'),
        ForeignKeyConstraint(['transmodel_txcfileattributes_id'], ['organisation_txcfileattributes.id'], deferrable=True, initially='DEFERRED', name='dqs_taskresults_transmodel_txcfileat_36d8a29c_fk_organisat'),
...
class NaptanLocality(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(['admin_area_id'], ['naptan_adminarea.id'], deferrable=True, initially='DEFERRED', name='naptan_locality_admin_area_id_0765cd72_fk_naptan_adminarea_id'),
        ForeignKeyConstraint(['district_id'], ['naptan_district.id'], deferrable=True, initially='DEFERRED', name='naptan_locality_district_id_39815ea9_fk_naptan_district_id'),
...
class TransmodelService(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(['revision_id'], ['organisation_datasetrevision.id'], deferrable=True, initially='DEFERRED', name='transmodel_service_revision_id_6a8e3139_fk_organisat'),
        ForeignKeyConstraint(['txcfileattributes_id'], ['organisation_txcfileattributes.id'], deferrable=True, initially='DEFERRED', name='transmodel_service_txcfileattributes_id_7b93a5d9_fk_organisat'),
...
class TransmodelVehiclejourney(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(['service_pattern_id'], ['transmodel_servicepattern.id'], deferrable=True, initially='DEFERRED', name='transmodel_vehiclejo_service_pattern_id_1b8caece_fk_transmode'),
...
class NaptanStoppoint(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(['admin_area_id'], ['naptan_adminarea.id'], deferrable=True, initially='DEFERRED', name='naptan_stoppoint_admin_area_id_6ccac623_fk_naptan_adminarea_id'),
        ForeignKeyConstraint(['locality_id'], ['naptan_locality.gazetteer_id'], deferrable=True, initially='DEFERRED', name='naptan_stoppoint_locality_id_4ef6e016_fk_naptan_lo'),
...
class TransmodelNonoperatingdatesexceptions(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(['vehicle_journey_id'], ['transmodel_vehiclejourney.id'], deferrable=True, initially='DEFERRED', name='transmodel_nonoperat_vehicle_journey_id_f3d4bc65_fk_transmode'),
...
class TransmodelOperatingdatesexceptions(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(['vehicle_journey_id'], ['transmodel_vehiclejourney.id'], deferrable=True, initially='DEFERRED', name='transmodel_operating_vehicle_journey_id_7df49157_fk_transmode'),
...
class TransmodelOperatingprofile(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(['vehicle_journey_id'], ['transmodel_vehiclejourney.id'], deferrable=True, initially='DEFERRED', name='transmodel_operating_vehicle_journey_id_64fb5bad_fk_transmode'),
...
class TransmodelServiceServicePatterns(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(['service_id'], ['transmodel_service.id'], deferrable=True, initially='DEFERRED', name='transmodel_service_s_service_id_6fae3b23_fk_transmode'),
        PrimaryKeyConstraint('id', name='transmodel_service_service_patterns_pkey'),
        UniqueConstraint('service_id', 'servicepattern_id', name='transmodel_service_servi_service_id_servicepatter_8d00b2d4_uniq')
    )
...
class TransmodelServicedorganisationvehiclejourney(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(['serviced_organisation_id'], ['transmodel_servicedorganisations.id'], deferrable=True, initially='DEFERRED', name='transmodel_servicedo_serviced_organisatio_4f5b7f54_fk_transmode'),
        ForeignKeyConstraint(['vehicle_journey_id'], ['transmodel_vehiclejourney.id'], deferrable=True, initially='DEFERRED', name='transmodel_servicedo_vehicle_journey_id_da3adc3a_fk_transmode'),
...
class TransmodelServicepatternstop(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(['stop_activity_id'], ['transmodel_stopactivity.id'], deferrable=True, initially='DEFERRED', name='transmodel_servicepa_stop_activity_id_cd96c52d_fk_transmode'),
        ForeignKeyConstraint(['vehicle_journey_id'], ['transmodel_vehiclejourney.id'], deferrable=True, initially='DEFERRED', name='transmodel_servicepa_vehicle_journey_id_32f3f1c9_fk_transmode'),
...
class DqsObservationresults(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(['service_pattern_stop_id'], ['transmodel_servicepatternstop.id'], deferrable=True, initially='DEFERRED', name='dqs_observationresults_service_pattern_stop_id_603d0be8_fk'),
        ForeignKeyConstraint(['serviced_organisation_vehicle_journey_id'], ['transmodel_servicedorganisationvehiclejourney.id'], deferrable=True, initially='DEFERRED', name='dqs_observationresul_serviced_organisatio_b564ba8e_fk_transmode'),
        ForeignKeyConstraint(['taskresults_id'], ['dqs_taskresults.id'], deferrable=True, initially='DEFERRED', name='dqs_observationresul_taskresults_id_80858afc_fk_dqs_taskr'),
        ForeignKeyConstraint(['vehicle_journey_id'], ['transmodel_vehiclejourney.id'], deferrable=True, initially='DEFERRED', name='dqs_observationresul_vehicle_journey_id_6e76a0f9_fk_transmode'),
...
class TransmodelServicedorganisationworkingdays(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(['serviced_organisation_vehicle_journey_id'], ['transmodel_servicedorganisationvehiclejourney.id'], deferrable=True, initially='DEFERRED', name='transmodel_servicedo_serviced_organisatio_f3dc5685_fk_transmode'),
        PrimaryKeyConstraint('id', name='transmodel_servicedorganisationworkingdays_pkey')
    )
