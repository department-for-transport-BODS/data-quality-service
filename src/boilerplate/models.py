...
class OrganisationDataset(Base):
    ...
    __table_args__ = (
        ...
        ForeignKeyConstraint(
            ["organisation_id"],
            ["public.organisation_organisation.id"],
            deferrable=True,
            initially="DEFERRED",
...
class OrganisationDatasetrevision(Base):
    ...
    __table_args__ = (
        ...
        ForeignKeyConstraint(
            ["dataset_id"],
            ["public.organisation_dataset.id"],
            deferrable=True,
            initially="DEFERRED",
        ...
        Index(
            "organisation_datasetrevision_last_modified_user_id_cfda7737",
            "last_modified_user_id",
        ),
        Index("organisation_datasetrevision_name_24f6c4c0_like", "name"),
        Index(
            "organisation_datasetrevision_published_by_id_4e5c02d1", "published_by_id"
        ),
        Index(
            "organisation_datasetrevision_unique_draft_revision",
            "dataset_id",
            unique=True,
        ),
        {"schema": "public"},
...
class DqsTaskresults(Base):
    ...
    __table_args__ = (
        ...
        ForeignKeyConstraint(
            ...
            ["public.organisation_txcfileattributes.id"],
            deferrable=True,
            initially="DEFERRED",
        ...
        Index(
            "dqs_taskresults_dataquality_report_id_b3cfb422", "dataquality_report_id"
        ),
        Index(
            "dqs_taskresults_transmodel_txcfileattributes_id_36d8a29c",
            "transmodel_txcfileattributes_id",
        ),
        {"schema": "public"},
    )
...
class TransmodelVehiclejourney(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ["service_pattern_id"],
            ["public.transmodel_servicepattern.id"],
            deferrable=True,
            initially="DEFERRED",
        ...
        Index(
            "transmodel_vehiclejourney_service_pattern_id_1b8caece",
            "service_pattern_id",
        ),
        {"schema": "public"},
    )
...
class TransmodelServicedorganisationvehiclejourney(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ...
            ["public.transmodel_servicedorganisations.id"],
            deferrable=True,
            initially="DEFERRED",
        ...
        ForeignKeyConstraint(
            ["vehicle_journey_id"],
            ["public.transmodel_vehiclejourney.id"],
            deferrable=True,
            initially="DEFERRED",
        ...
        Index(
            "transmodel_servicedorganis_serviced_organisation_id_4f5b7f54",
            "serviced_organisation_id",
        ),
        Index(
            "transmodel_servicedorganis_vehicle_journey_id_da3adc3a",
            "vehicle_journey_id",
        ),
        {"schema": "public"},
    )
...
class TransmodelServicepatternstop(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ["stop_activity_id"],
            ["public.transmodel_stopactivity.id"],
            deferrable=True,
            initially="DEFERRED",
        ...
        Index(
            "transmodel_servicepatternstop_naptan_stop_id_e9dd8eac", "naptan_stop_id"
        ),
        Index(
            "transmodel_servicepatternstop_service_pattern_id_c78a2156",
            "service_pattern_id",
        ),
        Index(
            "transmodel_servicepatternstop_stop_activity_id_cd96c52d",
            "stop_activity_id",
        ),
        Index(
            "transmodel_servicepatternstop_vehicle_journey_id_32f3f1c9",
            "vehicle_journey_id",
        ),
        {"schema": "public"},
    )
...
class DqsObservationresults(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ...
            ["public.transmodel_servicepatternstop.id"],
            deferrable=True,
            initially="DEFERRED",
        ...
        ForeignKeyConstraint(
            ...
            ["public.transmodel_servicedorganisationvehiclejourney.id"],
            deferrable=True,
            initially="DEFERRED",
        ...
        Index(
            "dqs_observationresults_service_pattern_stop_id_603d0be8",
            "service_pattern_stop_id",
        ),
        Index(
            "dqs_observationresults_serviced_organisation_vehi_b564ba8e",
            "serviced_organisation_vehicle_journey_id",
        ),
        Index("dqs_observationresults_taskresults_id_80858afc", "taskresults_id"),
        Index(
            "dqs_observationresults_vehicle_journey_id_6e76a0f9", "vehicle_journey_id"
        ),
        {"schema": "public"},
    )
